...
In Listing \ref{code:xtend_validation} is a simplified version of the implemented customizations, in Xtend, is presented for the validation of high-level rules. %, omitting the other cutomizations, as well as imports, auxiliary methods, among others
...
In the Listing \ref{code:xtend_quickfix} is a simplified version of the customizations implemented, in Xtend, is presented for the quickfix of high-level rules duplication validation.
