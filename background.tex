...
For this study, the PBT technique was selected due to the characteristics of the \callers, which differ basically by their declared properties and their values. A well-known tool, the Junit QuickCheck \footnote{https://pholser.github.io/junit-quickcheck/site/0.8.2/index.html}, was taken into consideration for use. Although there is documentation for this tool it was not possible to find examples that would make its use clearer in the case of SISDOT. Furthermore, it may be difficult to understand artifacts generated at runtime {\color{red}, pois não seria possível saber exatamente quais valores de propriedades estão sendo testados, a não ser pela leitura do log de execução.}. Other tools were found, such as: jqwik \footnote{https://jqwik.net/} and QuickTheories \footnote{https://github.com/ncredinburgh/QuickTheories}, but also incur the same problems, even though they have not been further analyzed background like Junit QuickCheck.
