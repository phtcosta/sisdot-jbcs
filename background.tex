...
Our DSL integrates with a \emph{property based testing} insfrastructure that
...
%% Elberzhager et al.~\cite{elberzhager2012} descreve algumas abordagens
%% para reduzir o esforço de teste sem que o \textit{software}
%% final perca qualidade. De acordo com a maioria dos artigos analisados,
%% cerca de 50\% discute a import\^{a}ncia da automação de testes.
%% Este resultado não é surpreendente, uma vez que ao aplicar abordagens
%% de automação de teste, o tempo gasto com os testes podem ser diminuídos,
%% reduzindo o custo do teste de \textit{software}~\cite{mahadik2016}.
%% A automação permite mais ciclos de teste devido a testes repetitíveis
%% e execuções de teste mais frequentes. Também facilita a verificação
%% rápida e eficiente de mudanças de requisitos e correções
%% de erros e minimiza os erros humanos \cite{xu2015}, \cite{mahadik2016}.
